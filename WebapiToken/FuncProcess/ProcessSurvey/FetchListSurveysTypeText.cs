    ...
    public static class FetchListSurveysTypeText
    {
        ...
        public static async Task<IQueryable<SurveyDetails>> getListSurveys(int skip_row, int page_size)
        {
            var list = (from a in db.surveys
                        ...
                        where a.surveys_type_id == b.id && a.surveys_type_id == 0 && a.deleted == false && a.publish == true
